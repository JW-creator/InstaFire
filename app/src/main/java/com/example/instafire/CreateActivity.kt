...
class CreateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val activity_create = binding.root
        ...
        val btnPickImage = binding.bthPickImage
    ...
    private fun handleSubmitButtonClick() {
        ...
        if(signedInUser == null) {
            Toast.makeText(this, "No user signed in, please wait", Toast.LENGTH_SHORT).show()
            return
        }
        ...
        photoReference.putFile(photoUploadUri)
            .continueWithTask { photoUploadTask ->
                Log.i(TAG, "Uploaded byte ${photoUploadTask.result?.bytesTransferred}")
            ...
            .addOnCompleteListener { postCreationTask ->
                ...
                if( !postCreationTask.isSuccessful ) {
                    Log.e(TAG, "Exception during FirebaseDb operations", postCreationTask.exception)
...
//        val intent = Intent(this, Intent.ACTION_GET_CONTENT)
